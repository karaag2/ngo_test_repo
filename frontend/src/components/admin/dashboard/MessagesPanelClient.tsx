              ...
              >
                ...
                <div className="flex items-center gap-x-2 pt-2">
                  <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-x-2 px-4 py-2 rounded-xl bg-primary text-primary-foreground text-xs font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 cursor-pointer"
                  >
                    {selectedMessage.read ? (
                      <>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-x-2 px-4 py-2 rounded-xl bg-destructive/10 text-destructive text-xs font-semibold hover:bg-destructive/15 transition-colors disabled:opacity-50 cursor-pointer"
                  >
