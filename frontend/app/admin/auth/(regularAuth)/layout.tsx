        ...
        <div className="px-4 md:px-10 lg:px-40 container mx-auto flex max-lg:flex-col gap-y-8 lg:gap-x-8 items-center">
          <div className="flex flex-col gap-y-8 w-full">
            <div className="flex flex-col gap-y-4">
              ...
              <p>
                Bienvenue dans l'espace d'administration du portail Makaranta.
                Vous disposez ici de tous les outils nécessaires à la gestion et
                à la mise à jour du contenu de votre site web.
              </p>
            </div>
            ...
            <div className="flex items-end px-6 py-6 relative  w-full min-h-50 md:h-96 rounded-4xl overflow-clip text-main">
              <Image
                src="/community-network.png"
                alt="Logo"
                sizes="100%"
                fill
                className="absolute top-0 left-0 object-cover -z-10"
              />
              <p className="text-xs text-blue-500/50 " style={{ WebkitTextStroke: "0.5px white" }}>
                Avec le portail admin MKRT, gagnez un temps précieux sur la
